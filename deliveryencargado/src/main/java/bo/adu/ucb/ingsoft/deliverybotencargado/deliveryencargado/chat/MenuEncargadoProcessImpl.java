...
//                            break;
                        case 3 : result = context.getBean(AgregarPlatoProcessImpl.class);
                            break;
                        case 4 : result = context.getBean(EditarPlatoProcessImpl.class);
                            break;
                        case 5 : result = context.getBean(PedidoProcessImpl.class);
                            break;
    ...
    private void showMainMenu(DeliveryLongPollingBot bot, Long chatId) {
        ...
        sb.append("3. Agregar Plato \r\n");
        sb.append("4. Editar Plato \r\n");
        sb.append("5. Eliminar Plato \r\n");
