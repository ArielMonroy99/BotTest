...
public class OrderDao {
    ...
    public List<OrderDto> findLas10Orders(Long chatId){
        ...
        List<PlateInOrderDto> list = new ArrayList<PlateInOrderDto>();
        list.add(new PlateInOrderDto(new PlateDto(1,"Sardinas al vapor",12.5,"platos de sardinas al vapor"),5));
        list.add(new PlateInOrderDto(new PlateDto(2,"Hamburguejas",30.5,"hamburguesas de lentejas"),3));
        list.add(new PlateInOrderDto(new PlateDto(3,"Lasaña de pollo",50.5,"Lasaña con salsa roja y trositos de pollo"),1));
        List<PlateInOrderDto> list1 = new ArrayList<PlateInOrderDto>();

        list1.add(new PlateInOrderDto(new PlateDto(1,"Papas fritas",15.5,"Como las papas normales pero fritas"),4));
        list1.add(new PlateInOrderDto(new PlateDto(2,"Quesadilla",20.5,"Quesadillas con queso"),2));
        list1.add(new PlateInOrderDto(new PlateDto(3,"Pollo al horno",50.5,"Pollo hecho al horno"),6));

        List<PlateInOrderDto> list2 = new ArrayList<PlateInOrderDto>();
        list2.add(new PlateInOrderDto(new PlateDto(1,"Pan de Muerto",12.5,"Pan con cenizas"),3));
        list2.add(new PlateInOrderDto(new PlateDto(2,"Locro de Zapallos",30.5,"Qué es locro?"),1));
        list2.add(new PlateInOrderDto(new PlateDto(3,"Super sopa de Mani",50.5,"Deliciosa sopa de maní kriptoniana"),5));
